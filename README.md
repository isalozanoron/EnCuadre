...
El sitio compilado queda en `encuadre-web/dist/encuadre-web/browser`. En un servidor web debe configurarse la redirección de rutas de la SPA a `index.html`.
